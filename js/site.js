...
(function () {
  ...
  var headerHtml =
    '<header class="site-header" id="siteHeader">' +
      '<div class="sh-inner">' +
        '<a href="index.html" class="sh-logo">Calculator</a>' +
  ...
  // Burger removed for the standalone calculator — no menu wiring needed.
  ...
  function buildFooter() {
    // Standalone calculator: no fanned mark and no email link in the footer.
    return;
  }
